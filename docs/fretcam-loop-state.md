...
| F9 | 031 barre boundary robustness (solver) | open — new item from the benchmark forensics | barre at canonical tip-x ≈1.66–1.98 sits on the fret-1/2 cell edge; a video re-encode flipped it II-for-I on all frames | needs its own scoped design; do not band-aid inside F6 | — |
