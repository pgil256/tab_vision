...
|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| `none` | 0.3202 | 0.4576 | 0.3889 | 0.4378 | 0.4879 | 0.9965 | 0.5122 | 0.6704 | 0.3132 | -0.1692 [-0.1928, -0.1463] |
| `position_only` | 0.5275 | 0.5678 | 0.5476 | 0.5515 | 0.6454 | 0.9967 | 0.3546 | 0.6584 | 0.2213 | -0.0104 [-0.0175, -0.0035] |
| `production_equivalent` | 0.5460 | 0.5701 | 0.5581 | 0.5577 | 0.6548 | 0.9967 | 0.3452 | 0.6146 | 0.2564 | baseline |
| `mode_specific` | 0.5523 | 0.5533 | 0.5528 | 0.5524 | 0.6479 | 0.9966 | 0.3521 | 0.6365 | 0.2596 | -0.0053 [-0.0172, +0.0067] |
...
Artifact and dataset provenance: `string_assignment_phase0_2026-07-27_provenance.json`. The grouped diagnostic summary includes candidate-rank, displacement, player/mode, pitch, style, and clip slices. The raw stable note table is generated locally and git-ignored because it is reproducible and approximately 30 MB. Runtime/peak-memory observations, exact command/environment, cache identities, and deterministic output hashes live in provenance.
