...
|---|---:|---:|---:|---:|---:|---:|---:|---:|
| `OOF baseline` | 0.5460 | 0.5701 | 0.5581 | 0.5577 | 0.6548 | 0.9967 | 0.3452 | baseline |
...
- Baseline decode benchmark: 1.388 s over 1828.1 s of player05 audio.
- Segment decode benchmark: 8.905 s; added 0.247 s per 60 s clip.
- Projected total: 45.25 s per 60 s clip, below the five-minute limit and below the +20% allowance.
...
- projected 60 s runtime 45.25 s
...
Full source/cache/output hashes and observational runtime data: `string_assignment_phase1_2026-07-27_provenance.json`.
