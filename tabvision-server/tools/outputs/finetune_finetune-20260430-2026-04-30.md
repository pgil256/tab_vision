...
| Note-event P (best) | 0.8692 | 0.8911 |
| Note-event R (best) | 0.8293 | 0.8657 |
| Note-event F1 (best) | 0.8453 | 0.8517 |

Best note-event threshold (track-wise mean): onset=0.21, frame=0.37.

Total reference notes across split: **8715**.
Total estimated notes at best thresholds: **7876**.

## Per-track table
See `finetune_finetune-20260430-2026-04-30.csv`.
